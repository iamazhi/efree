...
$jsRoot    = $webRoot . "js/";
$themeRoot = $webRoot . "template/shop/theme/";
?>
<!DOCTYPE html>
...
<head profile="http://www.w3.org/2005/10/profile">
  ...
  <?php $referer = isset($_SERVER['HTTP_REFERER']) ? helper::safe64Encode($_SERVER['HTTP_REFERER']) : ''; ?>
  <meta http-equiv='refresh' content="5;url='<?php echo helper::createLink('user', 'login', $referer);?>'">
  <?php endif;?>
  <?php
