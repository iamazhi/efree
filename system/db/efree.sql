...
) ENGINE=InnoDB AUTO_INCREMENT=535 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='购物车';

-- ----------------------------
--  Records of `ef_cart`
-- ----------------------------
BEGIN;
INSERT INTO `ef_cart` VALUES ('533', '1', '138', '1', 'admin', '2014-10-12 17:27:38'), ('534', '11', '38', '1', 'admin', '2014-10-12 17:40:04');
COMMIT;
...
CREATE TABLE `ef_order_detail` (
  ...
  `number` int(11) DEFAULT NULL COMMENT '商品数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=460 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='订单明细表';
...
-- ----------------------------
BEGIN;
INSERT INTO `ef_user` VALUES ('1', 'admin', '86f3059b228c8acf99e69734b6bb32cc', 'admin', '', 'super', '', '0000-00-00', 'u', '', '', '', '', '', '', '', '', '', '', '', '', '16', '127.0.0.1', '2014-10-12 15:53:39', '0', '', '2014-10-08 21:27:51', '', '0000-00-00 00:00:00', '0');
COMMIT;
