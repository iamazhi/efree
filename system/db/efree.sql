...
CREATE TABLE `ef_cart` (
  ...
  `price` float(11,2) DEFAULT NULL COMMENT '商品单价',
...
) ENGINE=InnoDB AUTO_INCREMENT=549 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='购物车';

-- ----------------------------
--  Records of `ef_cart`
-- ----------------------------
BEGIN;
INSERT INTO `ef_cart` VALUES ('548', '3', '28.20', '1', 'admin', '2014-10-31 17:03:34', 'normal');
COMMIT;
...
CREATE TABLE `ef_consignee` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='收货地址信息表';
...
CREATE TABLE `ef_order` (
  ...
  `status` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '订单状态',
  `cost` decimal(11,2) DEFAULT '0.00' COMMENT '总花费',
  `addedBy` varchar(60) COLLATE utf8_bin DEFAULT NULL COMMENT '创建者',
  `addedDate` datetime DEFAULT NULL COMMENT '下单时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='订单表';

-- ----------------------------
--  Records of `ef_order`
-- ----------------------------
BEGIN;
INSERT INTO `ef_order` VALUES ('2', 'unpaid', '148.00', 'admin', '2014-10-31 15:30:08'), ('3', 'unpaid', '40.00', 'admin', '2014-10-31 16:27:48'), ('4', 'unpaid', '600.00', 'admin', '2014-10-31 16:31:20'), ('5', 'unpaid', '600.00', 'admin', '2014-10-31 16:31:39'), ('6', 'unpaid', '334.20', 'admin', '2014-10-31 16:32:09'), ('7', 'unpaid', '1410.00', 'admin', '2014-10-31 16:33:24');
COMMIT;
...
-- ----------------------------
--  Records of `ef_order_detail`
-- ----------------------------
BEGIN;
INSERT INTO `ef_order_detail` VALUES ('7', '2', '9', '80.00', '1'), ('8', '2', '11', '38.00', '1'), ('9', '2', '6', '10.00', '3'), ('10', '3', '5', '40.00', '1'), ('11', '4', '7', '150.00', '4'), ('12', '5', '7', '150.00', '4'), ('13', '6', '5', '40.00', '1'), ('14', '6', '3', '28.20', '1'), ('15', '6', '9', '80.00', '1'), ('16', '6', '11', '38.00', '1'), ('17', '6', '6', '10.00', '1'), ('18', '6', '1', '138.00', '1'), ('19', '7', '3', '28.20', '50');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ef_user` VALUES ('1', 'admin', '86f3059b228c8acf99e69734b6bb32cc', 'admin', '', 'super', '', '0000-00-00', 'u', '', '', '', '', '', '', '', '', '', '', '', '', '27', '127.0.0.1', '2014-11-13 09:16:02', '0', '', '2014-10-08 21:27:51', '', '0000-00-00 00:00:00', '0');
COMMIT;
