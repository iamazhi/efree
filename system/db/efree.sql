...
CREATE TABLE `ef_consignee` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='收货地址信息表';
...
-- ----------------------------
BEGIN;
INSERT INTO `ef_user` VALUES ('1', 'admin', '86f3059b228c8acf99e69734b6bb32cc', 'admin', '', 'super', '', '0000-00-00', 'u', '', '', '', '', '', '', '', '', '', '', '', '', '23', '127.0.0.1', '2014-10-31 16:38:00', '0', '', '2014-10-08 21:27:51', '', '0000-00-00 00:00:00', '0');
COMMIT;
