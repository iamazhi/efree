...
<div class='panel'>
  <div class='panel-heading'><strong><i class='icon-edit'></i> <?php echo $lang->pay->typeList['alipay'];?></strong></div>
    ...
    <form method='post' id='ajaxForm' class='form-inline'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td class='col-xs-6'><?php echo html::input('notify_url', $notify_url, "class='form-control'");?></td><td></td>
        </tr>
        <tr>
          <th class='col-xs-2'><?php echo $lang->pay->return_url;?></th> 
          <td class='col-xs-6'><?php echo html::input('return_url', $return_url, "class='form-control'");?></td><td></td>
        </tr>
